	...
	<header>
		<nav class="header_nav_links">
			...
			<ul class="header_list_links mt-md-3" id="headerListLinks">
				...
				<li class="header_items">
					<a href="./client/page/admin/dashboard.php" class="header_link-login header_link-api">Panel
						Admin</a>
				</li>
				<?php endif; ?>
				<li class="header_items">
				...
				<div
					...
					<div class="trend_container">
						<a href="#" class="trend_container_link">
							<img src="./client/asset/images/peliculas/peli_1.jpg" alt="The Beekeeper"
								class="trend_image" />
							<div class="trend_container-hover">
								...
								<img src="./client/asset/images/film.ico" alt="icono pelicula"
					...
					<div class="trend_container">
						<a href="#" class="trend_container_link">
							<img src="./client/asset/images/peliculas/peli_2.jpg" alt="Badland Hunters"
								class="trend_image" />
							<div class="trend_container-hover">
					...
					<div class="trend_container">
						<a href="#" class="trend_container_link">
							<img src="./client/asset/images/peliculas/peli_3.jpg" alt="The Marvels"
								class="trend_image" />
							<div class="trend_container-hover">
					...
					<div class="trend_container">
						<a href="#" class="trend_container_link">
							<img src="./client/asset/images/peliculas/peli_5.jpg" alt="Aquaman Lost kingdom"
								class="trend_image" />
							<div class="trend_container-hover">
					...
					<div class="trend_container">
						<a href="#" class="trend_container_link">
							<img src="./client/asset/images/peliculas/peli_7.jpg" alt="60 minutes"
								class="trend_image" />
							<div class="trend_container-hover">
					...
					<div class="trend_container">
						<a href="#" class="trend_container_link">
							<img src="./client/asset/images/peliculas/peli_9.jpg" alt="The Masked Saint"
								class="trend_image" />
							<div class="trend_container-hover">
					...
					<div class="trend_container">
						<a href="#" class="trend_container_link">
							<img src="./client/asset/images/peliculas/peli_10.jpg" alt="Due Justice"
								class="trend_image" />
							<div class="trend_container-hover">
					...
					<div class="trend_container">
						<a href="#" class="trend_container_link">
							<img src="./client/asset/images/peliculas/peli_11.jpg" alt="Orion And The Dark"
								class="trend_image" />
							<div class="trend_container-hover">
					...
					<div class="trend_container">
						<a href="#" class="trend_container_link">
							<img src="./client/asset/images/peliculas/peli_12.jpg" alt="Genghis Khan"
								class="trend_image" />
							<div class="trend_container-hover">
				...
				<div class="col position-relative p-md-5">
					<section class="d-flex gap-md-5 gap-3 mt-5 mt-md-0 px-md-3 align-items-center acclaimeds_container"
						...
						<div class="acclaimed_container">
							<a href="#">
								<img src="./client/asset/images/peliculas/aclamada_1.jpg" alt="aclamada 1"
						...
						<div class="acclaimed_container">
							<a href="#">
								<img src="./client/asset/images/peliculas/aclamada_2.jpg" alt="aclamada 2"
									class="acclaimed_image" />
							</a>
						</div>
						<!-- aclamada 3 -->
						<div class="acclaimed_container">
							<a href="#">
								<img src="./client/asset/images/peliculas/aclamada_3.jpg" alt="aclamada 3"
									class="acclaimed_image" />
							</a>
						</div>
						<!-- aclamada 4 -->
						<div class="acclaimed_container">
							<a href="#">
								<img src="./client/asset/images/peliculas/aclamada_4.jpg" alt="aclamada 4"
									class="acclaimed_image" />
							</a>
						</div>
						<!-- aclamada 5 -->
						<div class="acclaimed_container">
							<a href="#">
								<img src="./client/asset/images/peliculas/aclamada_5.jpg" alt="aclamada 5"
									class="acclaimed_image" />
							</a>
						</div>
						<!-- aclamada 6 -->
						<div class="acclaimed_container">
							<a href="#">
								<img src="./client/asset/images/peliculas/aclamada_6.jpg" alt="aclamada 6"
									class="acclaimed_image" />
							</a>
						</div>
						<!-- aclamada 7 -->
						<div class="acclaimed_container">
							<a href="#">
								<img src="./client/asset/images/peliculas/aclamada_7.jpg" alt="aclamada 7"
									class="acclaimed_image" />
							</a>
						</div>
						<!-- aclamada 8 -->
						<div class="acclaimed_container">
							<a href="#">
								<img src="./client/asset/images/peliculas/aclamada_8.jpg" alt="aclamada 8"
									class="acclaimed_image" />
							</a>
						</div>
						<!-- aclamada 9 -->
						<div class="acclaimed_container">
							<a href="#">
								<img src="./client/asset/images/peliculas/aclamada_9.jpg" alt="aclamada 9"
									class="acclaimed_image" />
							</a>
						</div>
						<!-- aclamada 10 -->
						<div class="acclaimed_container">
							<a href="#">
								<img src="./client/asset/images/peliculas/aclamada_10.jpg" alt="aclamada 10"
									class="acclaimed_image" />
							</a>
						</div>
						<!-- aclamada 11 -->
						<div class="acclaimed_container">
							<a href="#">
								<img src="./client/asset/images/peliculas/aclamada_11.jpg" alt="aclamada 11"
									class="acclaimed_image" />
							</a>
						</div>
						<!-- aclamada 12 -->
						<div class="acclaimed_container">
							<a href="#">
								<img src="./client/asset/images/peliculas/aclamada_12.jpg" alt="aclamada 12"
									class="acclaimed_image" />
							</a>
						</div>
					</section>
