...
<div class="modal fade modal-preview" id="pelicula<?php echo $pelicula['id_pelicula'] ?>" tabindex="-1"
		...
		<div class="modal-content bg-dark">
			...
			<div class="modal-body m-auto">
				...
				<div class="card bg-card" style="width:18rem;border:2px solid #9f3647;">
					<img src="<?php echo !empty($pelicula['imagen']) || file_exists('../asset/upload/'.$pelicula['imagen']) ? $pelicula['imagen'] : '../../asset/images/no-disponible.jpg' ?>"
					...
					<div class="card-body">
						...
						<button class="mt-3 link_movie-add" data-bs-toggle="modal"
							data-bs-target="#cardDescription<?php echo $pelicula['id_pelicula']?>">Detalles</button>
						<!--	          <p class="card-text collapse position-absolute" id="cardDescription--><?php //echo $pelicula['id_pelicula']?>
...
<!--Modal Detalles -->
<div class="modal fade modal-preview" tabindex="-1" id="cardDescription<?php echo $pelicula['id_pelicula']?>"
	aria-hidden="true" aria-labelledby="exampleModalLabel2">
	<div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
		<div class="modal-content bg-dark">
			...
			<div class="modal-footer">
				<button class="link_movie-add" data-bs-toggle="modal"
					data-bs-target="#pelicula<?php echo $pelicula['id_pelicula']?>"><i
						class="fa-solid fa-caret-left"></i>Volver</button>
			</div>
		</div>
	</div>
</div>