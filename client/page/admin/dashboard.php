...
<body>
	...
	<main class="container-fluid p-5 container-api">
		<div class="d-flex align-items-center justify-content-between">
			...
			<a href="cargarPelicula.php" class="link_movie-add"><i class="fa-regular fa-file"></i>Agregar</a>
		</div>
		<section class="mt-5">
						...
						<table class="table table-dark table-hover table-bordered my-4" id="myTable">
							...
							<tbody>
								...
								<tr>
									...
									<!--										<td class="text-center align-middle table-image"><img data-bs-toggle="modal" data-bs-target="#imagen--><?php //echo $pelicula['id_pelicula']?>
									<!--" src="--><?php //echo !empty($pelicula['imagen']) || file_exists('../uploads/image/'.$pelicula['imagen']) ? $pelicula['imagen'] : '../../asset/images/no-disponible.jpg';?>
									<!--" alt="--><?php //echo $pelicula['nombre']?>
									<!--" class="table-image"></td>-->
									<td class="align-middle"><?php echo $pelicula['nombre'] ?></td>
									<!--										<td class="align-middle">--><?php //echo mb_substr($pelicula['descripcion'],0,50), strlen($pelicula['descripcion']) > 50 ? ' ...' :'' ?>
									<!--</td>-->
									<td class="align-middle"><?php echo $pelicula['genero']?></td>
									<!--										<td class="text-center align-middle">--><?php //echo $pelicula['calificacion']?>
									<!--</td>-->
										...
										<div class="d-flex justify-content-center align-items-center gap-3">
											<a role="button" data-bs-toggle="modal"
												data-bs-target="#pelicula<?php echo $pelicula['id_pelicula'] ?>"><i
													class="fa-regular fa-eye bg-none text-light text-hover"
													title="Vista Previa"></i></a>
											<a href="update_form.php?id=<?php echo $pelicula['id_pelicula']?>"><i
													class="fa-regular fa-pen-to-square text-pink text-hover"
													title="Editar"></i></a>
											<form action="delete_movie.php" method="POST"
												...
												<button type="button"
													...
													class="link-delete text-hover"><i
														class="fa-regular fa-trash-can text-danger text-hover"
