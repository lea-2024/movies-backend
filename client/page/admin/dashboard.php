...
<!--										<td class="text-center align-middle table-image"><img data-bs-toggle="modal" data-bs-target="#imagen--><?php //echo $pelicula['id_pelicula']?><!--" src="--><?php //echo !empty($pelicula['imagen']) || file_exists('../uploads/image/'.$pelicula['imagen']) ? $pelicula['imagen'] : '../../asset/images/no-disponible.jpg';?><!--" alt="--><?php //echo $pelicula['nombre']?><!--" class="table-image"></td>-->
										<td class="align-middle"><?php echo $pelicula['nombre'] ?></td>
<!--										<td class="align-middle">--><?php //echo mb_substr($pelicula['descripcion'],0,50), strlen($pelicula['descripcion']) > 50 ? ' ...' :'' ?><!--</td>-->
...
<!--										<td class="text-center align-middle">--><?php //echo $pelicula['calificacion']?><!--</td>-->
										...
										<td class="text-center align-middle"><input type="checkbox" id="estado<?php echo $pelicula['id_pelicula']?>" onchange="changeStatus(<?php echo $pelicula['id_pelicula']?>)" name="estado" <?php echo $pelicula['estado'] == 1 ? 'checked' : '' ?>></td>
										<td class="align-middle">
											<div class="d-flex justify-content-center align-items-center gap-3">
												...
												<form action="delete_movie.php" method="POST" id="formDelete<?php echo $pelicula['id_pelicula']?>">
													...
													<button type="button" onclick="confirmDelete('formDelete',<?php echo $pelicula['id_pelicula']?>)" class="link-delete text-hover"><i class="fa-regular fa-trash-can text-danger text-hover" title="Eliminar"></i></button>
												</form>
											</div>
										</td>
									</tr>
